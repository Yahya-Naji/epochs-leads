...
import { Users, CalendarCheck, ShieldCheck, PhoneCall } from "lucide-react";
...
export default function StatsCards({
  ...
  const confirmed = stats?.interested ?? 0;
  const cancelled = stats?.notInterested ?? 0;
  const rate =
